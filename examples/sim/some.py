...
def main():
    # print(generateDirectoryName(5,True))
    # os.mkdir(generateDirectoryName(5,True))
    # print(generateDirectoryName(5,False))
    # print("SV:")
    # print(generateFileName(4, ".sv"))
    # print(generateFileNameDm(4, ".sv"))
    
    # print("CORE: ")
    # print(generateFileName(4, ".core"))
    # print(generateFileNameDm(4, ".core"))
